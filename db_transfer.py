    ...
    def update_all_user(self, dt_transfer):
        ...
        for id in dt_transfer.keys():
            ...
            if transfer[0] + transfer[1] < update_trs and id not in self.force_update_transfer:
                ...
                print 'Port: %d  upload: %d  download: %d  Rate: %f , too less wait for next' % (id, transfer[0], transfer[1], get_config().NOW_SER_TRANSFER_MUL)
                continue
            ...
            print 'Port: %d  upload: %d  download: %d  Rate: %f' % (id,transfer[0],transfer[1],get_config().NOW_SER_TRANSFER_MUL)
